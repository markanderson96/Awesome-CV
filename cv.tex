...
\name{Mark}{Anderson}
\position{PhD Researcher in Electronic \& Electrical Engineering}
%\address{235, World Cup buk-ro, Mapo-gu, Seoul, 03936, Republic of Korea}

\mobile{+3538311157}
\email{andersm3@tcd.ie}
%\dateofbirth{January 1st, 1970}
\homepage{markanderson96.github.io}
\github{markanderson96}
\linkedin{markanderson96}
% \gitlab{gitlab-id}
...
\googlescholar{Mel-6GwAAAAJ}{Mark Anderson}
